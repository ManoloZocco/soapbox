...
const messages = defineMessages({
  ...
  subtitle: { id: 'moderation_overlay.subtitle', defaultMessage: 'This Truth has been sent to Moderation for review and is only visible to you. If you believe this is an error please contact Support.' },
